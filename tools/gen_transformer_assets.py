...
SPECS = [
    ...
    ("pad_1kv_240v", 2, "PAD"), ("pad_10kv_240v", 2, "PAD"), ("pad_1kv_208v", 3, "PAD"), ("pad_10kv_208v", 3, "PAD"), ("pad_10kv_480v", 3, "PAD"), ("pad_3500v_480v", 3, "PAD"), ("pad_8kv_480v", 3, "PAD"),
    ("sub_35kv_480v", 3, "POWER_S"), ("sub_35kv_10kv", 3, "POWER_S"), ("sub_35kv_8kv", 3, "POWER_S"), ("sub_100kv_35kv", 3, "POWER_L"),
...
BODY = {
    ...
    "PAD": (-3, 2, 1, 19, 18, 19), "POWER_S": (-7.5, 3.5, 1.5, 23.5, 24.5, 22.5), "POWER_L": (-10, 3.5, 1.5, 26, 24.5, 26.5),
    "DRY": (2, 0, 4, 14, 30, 16),
}
LID = {
    "POLE_S": (4.25, 10.5, 3.25, 11.75, 11.5, 11.75), "POLE_M": (3.5, 12, 2.5, 12.5, 13, 12.5), "POLE_L": (2.25, 18, 1.25, 13.75, 19.5, 13.75),
    "PAD": (-4, 18, 0, 20, 19.5, 20), "POWER_S": (-9, 24.5, 0, 25, 27, 24), "POWER_L": (-11.5, 24.5, 0, 27.5, 27, 28), "DRY": None,
}
SKID = {"PAD": (-4, 0, 0, 20, 2, 20), "POWER_S": (-9, 0, 0, 25, 3.5, 24), "POWER_L": (-11.5, 0, 0, 27.5, 3.5, 28)}
...
def hv_bushing(size, i, count):
    ...
    return {
        ...
        "POLE_L": (x - 1, top, 9.5, x + 1, top + 3, 11.5), "PAD": (x - 2.5, top, 12.5, x + 2.5, 28, 17.5),
        "POWER_S": (x - 2.5, top, 16.5, x + 2.5, 32, 21.5), "POWER_L": (x - 2.5, top, 20.5, x + 2.5, 32, 25.5),
    }[size]
...
def lv_bushing(size, j, count):
    ...
    return {
        ...
        "POLE_L": (x - 0.75, 6, z1 - 1, x + 0.75, 7.5, z1), "PAD": (x - 1.5, 19.5, 2.5, x + 1.5, 24, 5.5),
        "POWER_S": (x - 1.5, 27, 2.5, x + 1.5, 30, 5.5), "POWER_L": (x - 1.5, 27, 2.5, x + 1.5, 30, 5.5),
    }[size]
